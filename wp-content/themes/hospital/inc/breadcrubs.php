...
if ( ! function_exists( 'custom_breadcrumbs' ) ) {
        function custom_breadcrumbs ( $list_style = 'ol', $list_id = 'breadcrumb', $list_class = 'breadcrumb justify-content-center', $active_class = 'breadcrumb-item active', $echo = true ) {
            ...
            // Front page
            if ( is_front_page() ) {
                $breadcrumb .= '<li class="' . $active_class . '">' .  esc_html('Home','hospital'). '</li>';
            } else {
                $breadcrumb .= '<li class="breadcrumb-item"><a href="' . home_url() . '">' . esc_html('Home','hospital').'</a></li>';
            }
            // Blog archive
            ...
            // Search
            if ( is_search() ) {
                $breadcrumb .= '<li class="' . $active_class . '">' . esc_html( 'Search', $text_domain ) . '</li>';
            }
            // 404
            if ( is_404() ) {
                $breadcrumb .= '<li class="' . $active_class . '">' . esc_html( '404', $text_domain ) . '</li>';
            }
